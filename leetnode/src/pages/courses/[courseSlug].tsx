...
import { AppShell, SegmentedControl, Text, createStyles } from "@mantine/core";
import { Navbar as HeadNav } from "@mantine/core";
import {
  IconMessages,
      ...
      <AppShell
        ...
        navbar={
          ...
          >
            ...
            <HeadNav.Section grow mt="xl">
              {links}
            </HeadNav.Section>

            <HeadNav.Section className={classes.footer}>
              <a
                href="#" //back to courses list page
