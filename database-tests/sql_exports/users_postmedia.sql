...
CREATE TABLE `postmedia` (
  ...
  `postMediaURL` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`postID`),
  CONSTRAINT `postMedia_postID_fkey` FOREIGN KEY (`postID`) REFERENCES `posts` (`postID`) ON DELETE RESTRICT ON UPDATE CASCADE
